...
var encrypt_mcr = function (t) {
  ...
  for (var H, V, W = U, z = 3988292384, X = 256, Y = []; X--; Y[X] = W[G(h, -66)](H, 0)) for (V = 8, H = X; V--;) H = W[G(r, d)](H, 1) ? W[G(35, v)](H, 1) ^ z : W[G(h, g)](H, 1);
  return function (t) {
    function e(t, e) {
      return G(e - 1181, t);
    }
    ...
    for (r = 0, n = -1; W[e(R, 1044)](r, t[e(O, C)]); ++r) n = W[e(N, P)](Y[W[e(1229, B)](W[e(M, T)](n, 255), t[r])], W[e(j, 1125)](n, 8));
...
const x_s = "XYW_";
const a1 = "18edb7f2bd42lt1c2dtnnpsndf4ehxqnad4d9ix7630000373454";
const b1 = "";
