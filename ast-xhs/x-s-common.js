...
!function (t, e) {
  ...
  for (; ;)
    try {
      if (400191 === parseInt(E(-r, -n)) / 1 + parseInt(E(-o, -i)) / 2 * (parseInt(E(-a, -u)) / 3) + -parseInt(E(-329, -s)) / 4 * (parseInt(E(-c, -l)) / 5) + -parseInt(E(-362, -f)) / 6 * (parseInt(E(-p, -h)) / 7) + -parseInt(E(-d, -v)) / 8 * (parseInt(E(-g, -28)) / 9) + parseInt(E(-m, -y)) / 10 + parseInt(E(-w, -b)) / 11)
        break;
      _.push(_.shift())
    } catch (x) {
      _.push(_.shift())
