...
function encrypt_mcr (t) {
  ...
  return function (t) {
    ...
    if (W[e2(m, 1108)](typeof t, e2(y, 914))) {
      for (var r = 0, n = -1; W[e2(w, b)](r, t[e2(_, 1233)]); ++r)
        n = W[e2(E, x)](
          Y[W[e2(k, T)](n, 255) ^ t[e2(S, A) + e2(1022, L)](r)],
          n >>> 8
        );
      return W[e2(I, 1166)](n, -1) ^ z;
    }
    for (r = 0, n = -1; W[e2(R, 1044)](r, t[e2(O, C)]); ++r)
      n = W[e2(N, P)](
        Y[W[e2(1229, B)](W[e2(M, T)](n, 255), t[r])],
        W[e2(j, 1125)](n, 8)
      );
    return W[e2(F, B)](W[e2(D, 1122)](n, -1), z);
  };
}
...
function encrypt_encodeChunk(t, e, r) {
  ...
  for (var _ = e; y[b2(-63, -o)](_, r); _ += 3)
    n = y[b2(-i, -a)](y[b2(-166, -124)](t[_], 16), 16711680) + y[b2(-u, -205)](y[b2(s, -c)](t[_ + 1], 8), 65280) + y[b2(-l, -208)](t[y[b2(-350, -f)](_, 2)], 255),
      w[b2(p, 73)](y[b2(h, d)](encrypt_tripletToBase64, n));
  return w[b2(-v, -g)]("")
}
      ...
      case "4":
        V[W(-s, -c)](J, 1)
          ? ((Y = t[V[W(-l, -f)]($, 1)]),
            K[W(-p, -346)](
              V[W(-h, -d)](
                encrypt_lookup[V[W(-503, -v)](Y, 2)] +
                encrypt_lookup[V[W(-g, -741)](V[W(-331, -m)](Y, 4), 63)],
                "=="
              )
            ))
          : V[W(-y, -w)](J, 2) &&
          ((Y = V[W(-b, -_)](t[$ - 2], 8) + t[V[W(-l, -E)]($, 1)]),
            K[W(-333, -x)](
              V[W(-k, -505)](
                V[W(-T, -S)](
                  encrypt_lookup[Y >> 10],
                  encrypt_lookup[V[W(-A, -L)](Y >> 4, 63)]
                ) + encrypt_lookup[V[W(-I, -R)](V[W(-O, -C)](Y, 2), 63)],
                "="
              )
            ));
        continue;
        ...
        for (var Z = 0, tt = V[W(-509, -N)]($, J); V[W(-P, -B)](Z, tt); Z += Q)
          K[W(-M, -153)](
            V[W(-j, -F)](
              ...
              t,
              Z,
              V[W(-D, -413)](Z + Q, tt) ? tt : V[W(-q, -501)](Z, Q)
            )
          );
        continue;
      case "7":
...
console.log(encrypt_encodeUtf8(JSON.stringify({a:1})))
