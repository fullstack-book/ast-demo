var ParamsSign = (function () {
  ...
  var e = function (t) {
    ...
    S = h,
    j = function (t) {
      if ("Function" === w(t)) return S(t);
    },
    x = "object" == typeof document && document.all,
    O = { all: x, IS_HTMLDDA: void 0 === x && void 0 !== x },
    _ = O.all,
    E = O.IS_HTMLDDA
      ? function (t) {
  ...
  var N,
    ...
    $ = TypeError,
    V = function (t) {
      if (W(t)) throw $("Can't call method on " + t);
      return t;
    },
    z = U,
    K = V,
  ...
  var vt = D,
    ...
    Bt = function (t, r) {
      try {
        Gt(Ft, t, { value: r, configurable: !0, writable: !0 });
      } catch (e) {
        Ft[t] = r;
      }
      return r;
  ...
  var Jt = V,
    ...
    fr = function (t) {
      return (
        nr(ur, t) || (ur[t] = ir && nr(cr, t) ? cr[t] : sr("Symbol." + t)),
        ur[t]
      );
    },
    lr = A,
    ...
    hr = function (t, r) {
      ...
      if ("string" === r && Ct((e = t.toString)) && !Mt((n = Lt(e, t))))
        return n;
      if (Ct((e = t.valueOf)) && !Mt((n = Lt(e, t)))) return n;
      if ("string" !== r && Ct((e = t.toString)) && !Mt((n = Lt(e, t))))
        return n;
    ...
    gr = fr("toPrimitive"),
    mr = function (t, r) {
      if (!pr(t) || dr(t)) return t;
      var e,
        n = vr(t, gr);
      if (n) {
        if (
          (void 0 === r && (r = "default"), (e = lr(n, t, r)), !pr(e) || dr(e))
        )
          return e;
    ...
    Er =
      ...
      !o(function () {
        return (
          7 !=
          Object.defineProperty(_r("div"), "a", {
            get: function () {
              return 7;
            },
          }).a
  ...
  T.f = Tr
    ...
    : function (t, r) {
        ...
        if (Lr(t, r)) return Ir(!Pr(kr.f, t, r), t[r]);
      };
  var Nr = o,
    Dr = E,
    Fr = /#|\.prototype\./,
  ...
  Kr.f = re
    ...
    : function (t, r, e) {
        ...
        if ("get" in e || "set" in e) throw ae("Accessors not supported");
  ...
  var pe = Kr,
    ...
    Ge = Me
      ...
      : function (t) {
          var r = Ce(t);
          if (Re(r, Ne)) return r[Ne];
          var e = r.constructor;
          return Le(e) && r instanceof e
            ? e.prototype
            : r instanceof De
            ? Fe
            : null;
    ...
    $e = te,
    Ve = function (t) {
      if ("object" == typeof t || qe(t)) return t;
  ...
  var ao =
      ...
      function (t, r) {
        ...
        return (
          null !== t
            ? ((eo[Zn] = Vn(t)), (e = new eo()), (eo[Zn] = null), (e[ro] = t))
            : (e = io()),
          void 0 === r ? e : zn.f(e, r)
        );
      },
    ...
    yo = !o(function () {
      ...
      return (
        !("stack" in t) ||
        (Object.defineProperty(t, "stack", ho(1, 7)), 7 !== t.stack)
      );
    }),
    go = ve,
    mo = function (t, r) {
  ...
  var Eo = "[object z]" === String(_o),
    ...
    Fo = fr("iterator"),
    Go = function (t) {
      if (!No(t)) return Mo(t, Fo) || Mo(t, "@@iterator") || Do[Co(t)];
    },
    Bo = A,
    Ho = kt,
    qo = te,
    ...
    ui = function (t, r, e) {
      ...
      if (p) n = t.iterator;
        ...
        if (!(o = ni(t))) throw ii(Qo(t) + " is not iterable");
        if (Zo(o)) {
          for (i = 0, a = ti(t); a > i; i++)
            if ((c = g(t[i])) && ri(ci, c)) return c;
          return new ai(!1);
        }
        n = ei(t, o);
      }
      for (u = p ? t.next : n.next; !(s = Xo(u, n)).done; ) {
        ...
        if ("object" == typeof c && c && ri(ci, c)) return c;
      }
      return new ai(!1);
    },
    si = Lo,
    ...
    Pi = function (t, r) {
      var e,
        n = vi(ki, this);
      yi
        ? (e = yi(Ei(), n ? hi(this) : ki))
        : ((e = n ? this : mi(ki)), bi(e, _i, "Error")),
        void 0 !== r && bi(e, "message", Oi(r)),
        ji(e, Pi, e.stack, 1),
        arguments.length > 2 && Si(e, arguments[2]);
      var o = [];
      return xi(t, Ti, { that: o }), bi(e, "errors", o), e;
    };
  yi ? yi(Pi, Ei) : gi(Pi, Ei, { name: !0 });
  var ki = (Pi.prototype = mi(Ei.prototype, {
    constructor: wi(1, Pi),
    message: wi(1, ""),
    name: wi(1, "AggregateError"),
  }));
  di({ global: !0, constructor: !0, arity: 2 }, { AggregateError: Pi });
  var Ii,
    Ai,
    Ri,
    Li = E,
  ...
  [].keys &&
    ("next" in (Xi = [].keys())
      ? (Ki = fa(fa(Xi))) !== Object.prototype && (zi = Ki)
      : (da = !0));
  var va =
    !ua(zi) ||
    aa(function () {
  ...
  var ha = { IteratorPrototype: zi, BUGGY_SAFARI_ITERATORS: da },
    ya = Lo,
    ga = Eo
      ? {}.toString
      : function () {
    ...
    Oa = function (t, r, e, n) {
      if (t) {
        ...
        Sa(o, xa) || ba(o, xa, { configurable: !0, value: r }),
    ...
    Va = function (t, r, e, n, o, i, a) {
      ...
      if (
        (y &&
          (c = Ma(y.call(new t()))) !== Object.prototype &&
          c.next &&
          (Na(c, l, !0, !0), (Fa[l] = $a)),
        Ba &&
          o == Ja &&
        ...
        if (((u = { values: f(Ja), keys: i ? h : f(Ua), entries: f(Wa) }), a))
          for (s in u) (Ha || p || !(s in d)) && Da(d, s, u[s]);
        else Aa({ target: r, proto: !0, forced: Ha || p }, u);
      return a && d[qa] !== h && Da(d, qa, h, { name: o }), (Fa[r] = h), u;
    },
    za = function (t, r) {
  ...
  Za(
    ...
    "Array",
    function (t, r) {
      ec(this, { type: rc, target: Ka(t), index: 0, kind: r });
    },
    function () {
      var t = nc(this),
        r = t.target,
        ...
        n = t.index++;
      return !r || n >= r.length
        ? ((t.target = void 0), tc(void 0, !0))
        : tc("keys" == e ? n : "values" == e ? r[n] : [n, r[n]], !1);
    },
    "values"
  );
  ...
  var Ic,
    ...
    Jc = TypeError,
    Wc = function (t, r) {
      if (t < r) throw Jc("Not enough arguments");
      return t;
    },
  ...
  (iu && au) ||
    ...
    ou
      ...
      : Vc.addEventListener &&
        ...
        "file:" !== Ic.protocol &&
        !Qc(mu)
      ? ((Ac = mu), Vc.addEventListener("message", gu, !1))
      : (Ac =
          vu in ru("script")
            ? function (t) {
  ...
  if (!Uu) {
    ...
    Cu || Du || Nu || !Fu || !Gu
      ? !Mu && Hu && Hu.resolve
        ? (((Ou = Hu.resolve(void 0)).constructor = Hu),
          (_u = Iu(Ou.then, Ou)),
          (Su = function () {
            _u(Wu);
          }))
      ...
      : ((ju = !0),
        ...
        new Fu(Wu).observe(xu, { characterData: !0 }),
        (Su = function () {
          xu.data = ju = !ju;
        })),
      (Uu = function (t) {
  ...
  var $u = Uu,
    ...
    fs = ts("Promise", function () {
      var t = rs(Qu),
        r = t !== String(Qu);
      if (!r && 66 === is) return !0;
      if (!as.catch || !as.finally) return !0;
      if (!is || is < 51 || !/native code/.test(t)) {
        ...
        if (
          (((e.constructor = {})[cs] = n),
          !(us = e.then(function () {}) instanceof n))
        )
          return !0;
      }
      return !r && (ns || os) && !ss;
    }),
    ls = { CONSTRUCTOR: fs, REJECTION_EVENT: ss, SUBCLASSING: us },
    ps = {},
    ds = kt,
    vs = TypeError,
    hs = function (t) {
      ...
      (this.promise = new t(function (t, n) {
        if (void 0 !== r || void 0 !== e) throw vs("Bad Promise constructor");
        (r = t), (e = n);
      })),
        (this.resolve = ds(r)),
        (this.reject = ds(e));
  ...
  var ys,
    ...
    tf = function (t, r) {
      ...
      try {
        c
          ? (a || (2 === r.rejection && af(r), (r.rejection = 1)),
            !0 === c
              ? (e = i)
    ...
    ef = function (t, r, e) {
      var n, o;
      Ys
        ? (((n = Vs.createEvent("Event")).promise = r),
          (n.reason = e),
          n.initEvent(t, !1, !0),
          ws.dispatchEvent(n))
        ...
        !Bs && (o = ws["on" + t])
          ? o(n)
          : t === Qs && Rs("Unhandled promise rejection", e);
    },
    nf = function (t) {
      Ss(Is, ws, function () {
        var r,
    ...
    af = function (t) {
      Ss(Is, ws, function () {
        var r = t.facade;
        bs
          ? zs.emit("rejectionHandled", r)
          : ef("rejectionhandled", r, t.value);
      });
    },
    cf = function (t, r, e) {
      return function (n) {
    ...
    uf = function (t, r, e) {
      t.done ||
        ((t.done = !0), e && (t = e), (t.value = r), (t.state = 2), rf(t, !0));
    },
    sf = function (t, r, e) {
      if (!t.done) {
        (t.done = !0), e && (t = e);
        try {
          if (t.facade === r) throw $s("Promise can't be resolved itself");
          var n = Zs(r);
          n
            ? As(function () {
                var e = { done: !1 };
  ...
  Gs &&
    ...
    ms({ global: !0, constructor: !0, wrap: !0, forced: Gs }, { Promise: Js }),
    xs(Js, Fs, !1, !0),
    Os(Fs);
  var ff = fr("iterator"),
    lf = !1;
  ...
  zu && zu.prototype,
    jf(
      { target: "Promise", proto: !0, forced: xf, real: !0 },
      {
        catch: function (t) {
  ...
  var kf = A,
    If = ps;
  Ee(
    { target: "Promise", stat: !0, forced: ls.CONSTRUCTOR },
    {
      reject: function (t) {
        var r = If.f(this);
  ...
  var Af = te,
    ...
    Lf = ps,
    Cf = function (t, r) {
      if ((Af(t), Rf(r) && r.constructor === t)) return r;
      var e = Lf.f(t);
  ...
  Zf(
    {
      ...
      forced:
        !!tl &&
        rl(function () {
          al.finally.call({ then: function () {} }, function () {});
        }),
    },
    {
      finally: function (t) {
  ...
  var cl = h,
    ...
    hl = { codeAt: vl(!1), charAt: vl(!0) }.charAt,
    yl = li,
    gl = Yi,
    ml = Va,
    bl = za,
  ...
  ml(
    ...
    "String",
    function (t) {
      Sl(this, { type: wl, string: yl(t), index: 0 });
    },
    function () {
      var t,
        r = jl(this),
      ...
      return n >= e.length
        ? bl(void 0, !0)
        : ((t = hl(e, n)), (r.index += t.length), bl(t, !1));
    }
  );
  var xl = tt.Promise,
    Ol = {
  ...
  var $l = Bl.exports,
    ...
    yp = un,
    gp = function (t) {
      if (t > 9007199254740991) throw Kl("Maximum allowed index exceeded");
      return t;
    },
    mp = Zl,
    bp = ap,
  ...
  lp(
    { target: "Array", proto: !0, arity: 1, forced: !xp || !wp("concat") },
    {
      concat: function (t) {
        var r,
          e,
        ...
        for (r = -1, n = arguments.length; r < n; r++)
          if (Op((i = -1 === r ? a : arguments[r])))
            for (o = yp(i), gp(u + o), e = 0; e < o; e++, u++)
              e in i && mp(c, u, i[e]);
          else gp(u + 1), mp(c, u++, i);
        return (c.length = u), c;
      },
    }
  );
  ...
  var Fp = tt,
      ...
      return function (u, s, f, l) {
        for (
          var p,
            ...
            m = 0,
            b = l || Qp,
            w = r ? b(u, g) : e || a ? b(u, 0) : void 0;
          g > m;
          m++
        )
          if ((c || m in h) && ((d = y((p = h[m]), m, v)), t))
            if (r) w[m] = d;
            else if (d)
              switch (t) {
                case 3:
    ...
    nv = function (t, r) {
      var e = (Qd[t] = yd(Jd));
      return (
        Bd(e, { type: Fd, tag: t, description: r }),
        ad || (e.description = r),
        e
      );
    },
    ov = function (t, r, e) {
      ...
      return (
        ...
        sd(Qd, n)
          ? (e.enumerable
              ? (sd(t, Dd) && t[Dd][n] && (t[Dd][n] = !1),
                (e = yd(e, { enumerable: hd(0, !1) })))
              : (sd(t, Dd) || zd(t, Dd, hd(1, {})), (t[Dd][n] = !0)),
            ev(t, n, e))
          : zd(t, n, e)
      );
    },
    ...
    av = function (t) {
      var r = dd(t),
        e = od(Xd, this, r);
      return (
        !(this === qd && sd(Qd, r) && !sd(Zd, r)) &&
        (!(e || !sd(this, r) || !sd(Qd, r) || (sd(this, Dd) && this[Dd][r])) ||
          e)
      );
    },
    cv = function (t, r) {
      ...
      if (e !== qd || !sd(Qd, n) || sd(Zd, n)) {
        var o = Vd(e, n);
        return (
          !o || !sd(Qd, n) || (sd(e, Dd) && e[Dd][n]) || (o.enumerable = !0), o
        );
      }
    },
    uv = function (t) {
  ...
  cd ||
    ((Ud = function () {
      if (fd(Jd, this)) throw Wd("Symbol is not a constructor");
      var t =
      ...
      return ad && rv && ev(qd, r, { configurable: !0, set: e }), nv(r, t);
    }),
    ...
    ed(
      { global: !0, constructor: !0, wrap: !0, forced: !cd, sham: !cd },
      { Symbol: Ud }
    ),
    Nd(gd(tv), function (t) {
      Rd(t);
    ...
    ed(
      { target: "Object", stat: !0, forced: !cd, sham: !ad },
      {
        create: function (t, r) {
    ...
    ed(
      { target: "Object", stat: !0, forced: !cd },
  ...
  lv(
    { target: "Symbol", stat: !0, forced: !yv },
    {
      for: function (t) {
        var r = vv(t);
        if (dv(gv, r)) return gv[r];
        var e = pv("Symbol")(r);
  ...
  bv(
    { target: "Symbol", stat: !0, forced: !xv },
    {
      keyFor: function (t) {
        if (!Sv(t)) throw TypeError(jv(t) + " is not a symbol");
        if (wv(Ov, t)) return Ov[t];
      },
    }
  );
  var _v = zl,
    ...
    Zv = function (t, r) {
      ...
      if (Nv(n) || (void 0 !== t && !Dv(t)))
        return (
          (e[1] = function (t, r) {
            if ((Nv(n) && (r = Lv(n, this, Hv(t), r)), !Dv(r))) return r;
          }),
          Rv(qv, null, e)
        );
    },
    th = function (t, r, e) {
      var n = Jv(e, r - 1),
        o = Jv(e, r + 1);
      return (Uv(Kv, t) && !Uv(Xv, o)) || (Uv(Xv, t) && !Uv(Kv, n))
        ? "\\u" + Vv(Wv(t, 0), 16)
        : t;
    };
  qv &&
    Iv(
      { target: "JSON", stat: !0, arity: 3, forced: Yv || Qv },
      {
  ...
  for (
    var dh = Ee,
      ...
      bh = hh("Symbol"),
      wh = bh.isWellKnown,
      Sh = hh("Object", "getOwnPropertyNames"),
      jh = yh(bh.prototype.valueOf),
      xh = vh("wks"),
      Oh = 0,
      _h = Sh(bh),
      Eh = _h.length;
  ...
  function Ih(t) {
    return (
      (Ih =
        "function" == typeof Ph && "symbol" == typeof kh
          ? function (t) {
              return typeof t;
            }
          : function (t) {
  ...
  function Rh(t) {
    var r = (function (t, r) {
      if ("object" !== Ih(t) || null === t) return t;
      var e = t[Ah];
      if (void 0 !== e) {
        var n = e.call(t, r || "default");
        if ("object" !== Ih(n)) return n;
  ...
  var Mh = n;
  Ee({ global: !0, forced: Mh.globalThis !== Mh }, { globalThis: Mh });
  var Nh = n,
    Dh = { exports: {} },
    Fh = { exports: {} };
  !(function (t) {
    ...
    function n(o) {
      return (
        (t.exports = n =
          "function" == typeof r && "symbol" == typeof e
            ? function (t) {
                return typeof t;
              }
            : function (t) {
    ...
    Ee({ target: "Object", stat: !0, sham: !P }, { create: ao });
  var Gh = tt.Object,
    Bh = function (t, r) {
  ...
  Ee({ target: "Array", proto: !0, forced: [].forEach != zh }, { forEach: zh });
  var Kh = tt,
    Xh = function (t) {
    ...
    ry = Yh,
    ey = Array.prototype,
    ny = { DOMTokenList: !0, NodeList: !0 },
    oy = function (t) {
      var r = t.forEach;
      return t === ey || (ty(ey, t) && r === ey.forEach) || Zh(ny, Qh(t))
        ? ry
        : r;
    };
  Ee({ target: "Object", stat: !0 }, { setPrototypeOf: ze });
  var iy = tt.Object.setPrototypeOf,
    ...
    sy = [1, 2];
  ay(
    { target: "Array", proto: !0, forced: String(sy) === String(sy.reverse()) },
    {
      reverse: function () {
  ...
  var fy = Xh("Array").reverse,
    ...
    Py = Math.max;
  hy(
    { target: "Array", proto: !0, forced: !_y },
    {
      slice: function (t, r) {
        var e,
          n,
        ...
        if (
          ...
          return Oy(i, c, u);
        for (
          n = new (void 0 === e ? Ty : e)(Py(u - c, 0)), o = 0;
          c < u;
          c++, o++
        )
          c in i && jy(n, o, i[c]);
  ...
  !(function (t) {
    ...
    function l() {
      ...
      function w(t, r, n) {
        return (
          e(t, r, { value: n, enumerable: !0, configurable: !0, writable: !0 }),
          t[r]
        );
      }
      try {
      ...
      function S(t, r, e, n) {
        var i = r && r.prototype instanceof O ? r : O,
          a = o(i.prototype),
          c = new N(n || []);
        return h(a, "_invoke", { value: R(t, e, c) }), a;
      }
      function j(t, r, e) {
        try {
      ...
      function A(t, e) {
        function n(o, i, a, c) {
          ...
          if ("throw" !== u.type) {
            var s = u.arg,
              f = s.value;
            return f && "object" == r(f) && v.call(f, "__await")
        ...
        if (t) {
          ...
          if (!isNaN(t.length)) {
            var e = -1,
              n = function r() {
                for (; ++e < t.length; )
                  if (v.call(t, e)) return (r.value = t[e]), (r.done = !1), r;
      ...
      return (
        (_.prototype = E),
        h(k, "constructor", { value: E, configurable: !0 }),
        h(E, "constructor", { value: _, configurable: !0 }),
        ...
        (p.mark = function (t) {
          return (
            c ? c(t, E) : ((t.__proto__ = E), w(t, b, "GeneratorFunction")),
            (t.prototype = o(k)),
            t
          );
        }),
        ...
        (N.prototype = {
          ...
          delegateYield: function (t, r, e) {
            return (
              (this.delegate = { iterator: D(t), resultName: r, nextLoc: e }),
  ...
  try {
    ...
    "object" === (void 0 === Nh ? "undefined" : Ih(Nh))
      ? (Nh.regeneratorRuntime = Cy)
      : Function("r", "regeneratorRuntime = r")(Cy);
  }
  var Ny = Ee,
    Dy = Date,
  ...
  var Gy = tt.Date.now,
    ...
    Qy =
      ...
      Uy(function () {
            ...
            Ky(
              ...
              Ky(
                Xy({}, "a", {
                  enumerable: !0,
                  get: function () {
                    Xy(this, "b", { value: 3, enumerable: !1 });
                  },
                }),
                { b: 2 }
              )
        ...
        ? function (t, r) {
            for (
              var e = Vy(t), n = arguments.length, o = 1, i = Wy.f, a = $y.f;
              n > o;
              ...
              for (
                var c,
                  u = zy(arguments[o++]),
                  s = i ? Yy(Jy(u), i(u)) : Jy(u),
                  f = s.length,
                  l = 0;
                f > l;

              )
                (c = s[l++]), (By && !qy(a, u, c)) || (e[c] = u[c]);
            return e;
          }
        : Ky,
    Zy = Qy;
  Ee(
    { target: "Object", stat: !0, arity: 2, forced: Object.assign !== Zy },
    { assign: Zy }
  );
  var tg = tt.Object.assign,
    ...
    ag = rd.map;
  Ee(
    { target: "Array", proto: !0, forced: !fp("map") },
    {
      map: function (t) {
  ...
  var vg = tt.Object.keys,
    ...
    xg = { start: jg(1), end: jg(2), trim: jg(3) },
    Og = n,
    _g = o,
    Eg = h,
    Tg = li,
    ...
    Mg =
      ...
      (Rg &&
        ...
        : Ig;
  Ee({ global: !0, forced: parseInt != Mg }, { parseInt: Mg });
  var Ng = tt.parseInt,
    Dg = Ee,
    Fg = dn.indexOf,
    Gg = $h,
    ...
    Hg = !!Bg && 1 / Bg([1], 1, -0) < 0;
  Dg(
    { target: "Array", proto: !0, forced: Hg || !Gg("indexOf") },
    {
      indexOf: function (t) {
  ...
  om(
    { global: !0, bind: !0, forced: im.setInterval !== am },
    { setInterval: am }
  );
  var cm = Ee,
    um = n,
  ...
  cm(
    { global: !0, bind: !0, forced: um.setTimeout !== sm },
    { setTimeout: sm }
  );
  ...
  function gm(t) {
    if (t) {
      for (
        var r, e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), o = 1;
        o < e;
        o++
      )
        n[o - 1] = arguments[o];
          ...
          return My.wrap(function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  return (
                    (e = n.length > 1 && void 0 !== n[1] ? n[1] : 15e3),
                    t.abrupt(
                      "return",
                      new Nl(function (t, n) {
                        var o = function (t) {
          ...
          return My.wrap(function (t) {
            for (;;)
              switch ((t.prev = t.next)) {
                case 0:
                  if (
                    ((e = i.length > 1 && void 0 !== i[1] ? i[1] : 15e3),
  ...
  function xm(t) {
    ...
    return (
      (window.__JDWEBSIGNHELPER_$DATA__ =
        window.__JDWEBSIGNHELPER_$DATA__ || {}),
      (window.__JDWEBSIGNHELPER_$DATA__[t] =
        window.__JDWEBSIGNHELPER_$DATA__[t] ||
        ("function" == typeof (r = e) ? r() : r))
    );
  }
  var Om = Object.freeze({
      ...
      containsReservedParamName: function (t) {
        for (var r = vg(t), e = 0; e < r.length; e++) {
          var n = r[e];
          if ($g(hm).call(hm, n) >= 0) return !0;
        }
        return !1;
      },
      toArray: ym,
      toBase64: function (t) {
        return (t + Ly("===").call("===", (t.length + 3) % 4))
          .replace(/-/g, "+")
          .replace(/_/g, "/");
      },
    ...
    Tm = tt,
    Pm = f;
  Tm.JSON || (Tm.JSON = { stringify: JSON.stringify });
  var km,
    Im,
    Am = function (t, r, e) {
  ...
  if (!Hm.callbackName) {
    for (
      ...
      for (var Jm = 0; Jm < 26; Jm++) qm.push(qm[26 * Um + Jm] + qm[Jm]);
    Hm.callbackName = qm;
  }
  function Wm(t) {
    t = t || {};
  ...
  function $m(t) {
    ...
    if (
      ...
      return (
        o ||
          ...
          (e.url = Ym(
            e.url,
            e.jsonp ? e.jsonp + "=?" : !1 === e.jsonp ? "" : "callback=?"
          ))),
        (e.url = Qm(e.url, "ls")),
        (function (t) {
          var r;
          if (!r) {
            ...
            r =
              ...
              "jsonpCBK" +
                Hm.callbackName[Hm.ajaxCount++ % Hm.callbackName.length];
          }
          var n,
            o,
          ...
          (t.callbackName = r),
            ...
            (i.onload = i.onerror =
              function (r, e) {
                if ((clearTimeout(o), u)) return Gm(t.debug, "timeout"), !1;
                "error" == r.type
                  ? (Gm(t.debug, t.url, e || r.type || "error"),
                    zm(null, "error", a, t))
                  : n
                  ? Vm(n[0], a, t)
                  : zm(null, r.type, a, t),
    ...
    if (
      ...
      u("Accept", a || "*/*"),
      (a = e.mimeType) &&
        ($g(a).call(a, ",") > -1 && (a = a.split(",", 2)[0]),
        f.overrideMimeType && f.overrideMimeType(a)),
      (e.contentType ||
        (!1 !== e.contentType && e.data && "GET" != e.method)) &&
        u("Content-Type", e.contentType || "application/x-www-form-urlencoded"),
      e.headers)
    )
    ...
    if (e.xhrFields) for (var v in e.xhrFields) f[v] = e.xhrFields[v];
    for (var h in (f.open(e.method, e.url, d, e.username, e.password), c))
      l.apply(f, c[h]);
    if (
      (e.timeout > 0 &&
        (i = fm(function () {
      ...
      "POST" == e.method &&
        ...
        "object" == Ih(t.data) &&
        e.contentType &&
        $g((r = e.contentType)).call(r, "multipart/form-data") >= 0)
    ) {
      var y = new FormData();
  ...
  function zm(t, r, e, n) {
    ...
    n.retry <= 0 ||
    "POST" == n.method ||
    $g((o = ["error", "parsererror"])).call(o, r) >= 0
      ? Km(t, r, e, n)
      : fm(function () {
  ...
  function Qm(t, r) {
    ...
    if (
      "" == t ||
      0 !=
        $g((e = $g(t).call(t, "://") < 0 ? location.href : t)).call(e, "http")
    )
      return t;
    if (-1 != $g(t).call(t, "#")) {
      var i = t.match(/\?.+#/);
    ...
    return "" == o
      ? t + (-1 != $g(t).call(t, "?") ? "&" : "?") + "g_ty=" + r
      : t + (-1 != $g(t).call(t, "?") ? "&" : "?") + "g_tk=" + o + "&g_ty=" + r;
  }
  function Zm(t) {
    ...
    t.data &&
      "GET" == t.method &&
      ((t.url = Ym(t.url, t.data)), (t.data = void 0));
  }
  function tb(t) {
    return new Nl(function (r, e) {
      ...
      if (t) {
        ...
        if (
          ...
          !o.method ||
            (o.contentType &&
              -1 != $g((n = o.contentType)).call(n, "multipart/form-data")) ||
            Zm(o),
          o.expire)
        ) {
          o.cache_key = o.url;
          try {
            r({ body: Dm.getSync(o.cache_key) });
          } catch (t) {
            $m(o);
          }
        } else $m(o);
  ...
  function eb(t) {
    for (var r = 1, e = arguments.length; r < e; r++)
      for (var n in arguments[r]) t[n] = arguments[r][n];
    return t;
  }
  function nb(t) {
    return function (r, e) {
  ...
  var ab = 5,
    cb = -2;
  wm(
    "https://storage.360buyimg.com/webcontainer/main/js_security_v3_main_0.1.8.js?v=" +
      ib(Gy() - 36e5 * 1.1, "yyyyMMdd"),
    1e3,
    2
  )
    .then(function (t) {
      ...
      Ch(t, [
        {
          ...
          value: function (t) {
            ...
            (dm(t.appId) && t.appId) ||
              ...
              (this.__storageErrorReportConfigKey = ig(
                (r = "".concat(_m, "_"))
              ).call(r, this.__appId));
          },
        },
                      ...
                      switch ((t.prev = t.next)) {
                        ...
                        case 8:
                          return (
                            ...
                            gm(
                              this.__debug,
                              "retry load script elapsed time!=".concat(a, "ms")
                            ),
                        ...
                        case 17:
                          return (
                            ...
                            (n.signInterval = Gy() - e),
                            (n.errorCode = cb),
                            (n.errorMsg = "loader other failed.error:".concat(
                              t.t0
                            )),
                            window.ParamsSignMain ||
                              ((n.errorCode = ab),
                              (n.errorMsg = "load script failed.error:".concat(
                                t.t0
                              ))),
                            this.sendError(n),
                            r.h5st || (r.h5st = "null"),
                ...
                .then(function (t) {
                  ...
                  if (200 === r.status && r.data) {
                    ...
                    o &&
                      e.__appId === o &&
                      i &&
                      Nm.setSync(e.__storageErrorReportConfigKey, i, {
                        expire: 31536e3,
                      });
                  }
                })
  ...
  return (ub.settings = { debug: !1, retry2load: !0 }), ub;
})();
