...
function encrypt_mcr(t) {
  ...
  for (var H, V, W = U, z = 3988292384, X = 256, Y = []; X--; Y[X] = W["lxMGQ"](H, 0)) for (V = 8, H = X; V--;) H = W["vTINI"](H, 1) ? W["lxMGQ"](H, 1) ^ 3988292384 : W["lxMGQ"](H, 1);
  return function (t) {
...
function encrypt_tripletToBase64(t) {
  var e = 11,
    ...
    v = 335,
    g = {};
  g["BWbtU"] = function (t, e) {
    return t + e;
  }, g["ionFq"] = function (t, e) {
    return t >> e;
  }, g["Bjniw"] = function (t, e) {
    return t & e;
  }, g["eJzqq"] = function (t, e) {
    return t >> e;
  }, g["rviFu"] = function (t, e) {
    return t & e;
  };
  var y = g;
  return y["BWbtU"](encrypt_lookup[63 & y["ionFq"](t, 18)], encrypt_lookup[y["Bjniw"](y["eJzqq"](t, 12), 63)]) + encrypt_lookup[t >> 6 & 63] + encrypt_lookup[y["rviFu"](t, 63)];
}
function encrypt_encodeChunk(t, e, r) {
  var n,
    ...
    w = [];
  for (var _ = e; y["hwomB"](_, r); _ += 3) n = y["iHUeL"](y["ELxEv"](t[_], 16), 16711680) + y["iHUeL"](y["lBuRH"](t[_ + 1], 8), 65280) + y["SkIJl"](t[y["JYxWY"](_, 2)], 255), w["push"](y["CxjtF"](encrypt_tripletToBase64, n));
  return w["join"]("");
}
